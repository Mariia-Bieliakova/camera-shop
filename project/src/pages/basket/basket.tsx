                ...
                <ul className="basket__list">
                  <li className="basket-item">
                    ...
                    <div className="quantity">
                      ...
                      <input type="number" id="counter1" value="2" min="1" max="99" aria-label="количество товара" onChange={() => 1}/>
                  ...
                  <li className="basket-item">
                    ...
                    <div className="basket-item__description">
                      ...
                      <ul className="basket-item__list">
                        <li className="basket-item__list-item">
                          <span className="basket-item__article">Артикул:</span> <span className="basket-item__number">DA4IU67AD5</span>
                        </li>
                      ...
                      <form action="#">
                        <div className="custom-input">
                          <label>
                            ...
                            <input type="text" name="promo" placeholder="Введите промокод" onChange={() => 1}/>
                          </label>
